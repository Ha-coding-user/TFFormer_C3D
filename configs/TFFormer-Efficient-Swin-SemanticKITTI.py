...
point_cloud_range = [0, -25.6, -2, 51.2, 25.6, 4.4]     # Same as HTCL!!!
occ_size = [256, 256, 32]       # Same as HTCL!!!
voxel_size = [0.4, 0.4, 6.4]    # TODO: Check this params
...
# model
numC_Trans = 128    # Same as HTCL!!!
lss_downsample = [2, 2, 2]  # Same as HTCL!!!
voxel_out_channels = [128]  
norm_cfg = dict(type='GN', num_groups=32, requires_grad=True)   # Same as HTCL!!!
...
model = dict(
    ...
    view_transformer_layer=dict(
        ...
        proposal_layer=dict(
            ...
            factor=_interpolation_factor_,
            data_config=data_config,
            init_cfg=None
        ),
        img_projection_layer=dict(
            type='ImgProjectionLayer',
            C_in=640,
            C_out=_dim_,
            kernel_size=1
        ),
        point_feature_alignment=dict(
            type='PointFeatureAlignment',
            n_points=4,
            factor=_interpolation_factor_,
            img_size=(384, 1280),
            pcd_range=point_cloud_range
        ),
        voxel_refinement_layer=dict(
            type='VoxFormerHead',
            volume_h=128,
            volume_w=128,
            volume_z=16,
    ...
    occ_encoder_backbone=dict(
        ...
        global_aggregator=dict(
            ...
            global_encoder_backbone=dict(
                ...
                init_cfg=dict(
                    type='Pretrained',
                    checkpoint='/nas1/hamyo/model_weights/CGFormer_others/swin_tiny_patch4_window7_224.pth'),
                    ),
