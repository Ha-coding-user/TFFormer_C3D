...
class LoadAnnotationOcc():
    ...
    def forward_test(self, results):
        ...
        imgs, rots, trans, intrins, post_rots, post_trans, sensor2sensors, cam2world = results['img_inputs']

        results['img_inputs'] = (imgs, rots, trans, intrins, post_rots, post_trans, bda_rot, sensor2sensors, cam2world)
        return results
